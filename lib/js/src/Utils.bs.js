...
function getNeighbourValue(row, col, grid) {
  ...
  return List.mapi((function (rowIndex, row) {
                return List.mapi((function (colIndex, value) {
                              ...
                              var totalNeighbours = neighbours.reduce((function (total, list) {
                                      return total + getNeighbourValue(Caml_array.caml_array_get(list, 0), Caml_array.caml_array_get(list, 1), grid) | 0;
                                    }), 0);
...
exports.getNeighbourValue = getNeighbourValue;
